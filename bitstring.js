(function(){
  var SEEK_ABSOLUTE, SEEK_RELATIVE, SEEK_FROM_EOF, bin, hex, binlen, mask, chr, ord, BitString, exports;
  SEEK_ABSOLUTE = 0;
  SEEK_RELATIVE = 1;
  SEEK_FROM_EOF = 2;
  bin = function(n){
  ...
  if (typeof define === 'function' && define.amd) {
    define('bitstring', [], function(require, exports, module){
      return module.exports = BitString;
    });
